...
let kanallar = ["bot-commands","ship-chat"]
...
if(random >= 98) shipdurum = "💖💖💖💖💖💖💖💖💖💖";
    ...
    if (random >= 60) {
      ...
      const attachment = new MessageAttachment(canvas.toBuffer(), 'papaz.png');
...
${shipdurum}`)
.setImage("attachment://papaz.png")
message.channel.send({ content: `**[ \`${member.user.tag}\` ]**`, embeds: [papaz], files: [attachment] })
} else if (random <= 40) {
