...
module.exports = {
    ...
    if(!papaz.staffs.some(rol => member.roles.cache.has(rol))) return message.react(red)
...
${member.toString()}, (${member.roles.highest}) rolüne ait görevlerin aşağıda belirtilmiştir. Görevler tamamlandığında yetkin yükselecektir!
